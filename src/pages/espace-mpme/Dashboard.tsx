...
const notifications = [
  {
    id: 1,
    text: "Votre profil est complété à 65 %. Ajoutez vos documents pour progresser.",
    date: "Aujourd'hui, 09:14",
    unread: true,
  },
  {
    id: 2,
    text: "Module 3 du plan d'affaires maintenant disponible.",
    date: "Hier, 14:32",
    unread: true,
  },
  {
    id: 3,
    text: "Session présentielle le 15 mars 2026 à Bujumbura.",
    date: "22 fév. 2026",
    unread: false,
  },
  {
  ...
  {
    id: 5,
    text: "Bienvenue sur la plateforme COPA !",
    date: "20 fév. 2026",
    unread: false,
  },
];
  ...
  render() {
    return (
      <div className="site-main">
        ...
        <PageHeader title="Mon tableau de bord" breadcrumb="Espace MPME" />
                      ...
                      {notifications.map((n) => (
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <time style={{ fontSize: 11, color: "#777" }}>
                              {n.date}
                            </time>
                          </div>
                        </li>
                  ...
                  <div className="col-md-12">
                    <ProfileHeader
                      ...
                      onPhotoUpdate={(photoUrl) => {
                        // Optionnel : mettre à jour l'état parent
                        this.setState({ photoPreview: photoUrl });
                      }}
                    />
                    {/* <div className="candidate-data">
                      ...
                      <div className="candidate-caption">
                        ...
                        <div className="meta-line">
                          <span>
                            <i className="ti ti-briefcase" /> {user.sector}
                          </span>
                          <span>
                            <i className="ti ti-location-pin" /> {user.province}
                          </span>
                          <span>
                            <i className="ti ti-headphone" /> {user.phone}
                          </span>
                        </div>
                      </div>
                    </div> */}
                  ...
                  <div className="col-lg-12 col-md-12">
                    ...
                    <div className="overview-box">
                      ...
                      <div className="desc pb-30">
                        ...
                        <div className="ttm-progress-bar clearfix">
                          <h3 className="progressbar-title">
                            Formations ({user.trainings.done}/
                            {user.trainings.total} modules — {trainPct} %)
                          </h3>
                          ...
                          {[
                            {
                              ...
                              desc: "Renseignez vos informations personnelles et d'entreprise.",
                            },
                            {
                              to: "/espace-mpme/mes-formations/en-cours",
                              icon: "ti-book",
                              label: "Mes formations",
                              desc: `${user.trainings.done}/${user.trainings.total} modules terminés.`,
                            },
                            {
                              to: "/espace-mpme/mon-plan-affaires/redaction",
                              icon: "ti-files",
                              label: "Plan d'affaires",
                              desc: `Statut actuel : ${user.planStatus}.`,
                            },
                            {
                              to: "/espace-mpme/mon-profil/documents",
                              icon: "ti-clip",
                              label: "Mes documents",
                              desc: "Téléversez vos pièces justificatives.",
                            },
                          ].map((a) => (
                ...
                <div className="d-md-flex align-items-center justify-content-between">
                  ...
                  <div className="featured-icon-box icon-align-before-content style2">
                    ...
                    <div className="featured-content">
                      ...
                      <div className="featured-desc">
                        <p>
                          Notre équipe d'accompagnement est disponible pour vous
